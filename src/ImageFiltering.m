...
% Last Modified by GUIDE v2.5 03-May-2020 09:43:06
...
set(handles.uipanelMask, 'visible', 'off')
...
% handles    structure with handles and user data (see GUIDATA)
if get(handles.radiobuttonPixel, 'value') == 1.0
    set(handles.uipanelMask, 'visible', 'off')
    set(handles.uipanelPixel, 'visible', 'on')
else
    set(handles.uipanelMask, 'visible', 'on')
    set(handles.uipanelPixel, 'visible', 'off')
end
